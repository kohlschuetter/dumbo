(function($) {
  ...
  var processChunk = function(chunk) {
    if (chunk == null) {
      ...
      // no-op, continue
      return true;
    } else if (chunk.javaClass == "com.kohlschutter.dumbo.console.Console$ShutdownNotice") {
      ...
      $.app.console._onClose();
      return false;
    } else if (chunk.javaClass == "com.kohlschutter.dumbo.console.Console$MultipleChunks") {
