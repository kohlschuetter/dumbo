...
/**
 * Provides simple means of communication between the JavaScript and the Java parts of the
 * app.
 */
public interface AppControlService {
   ...
   * 
   * @param appId The unique ID that was returned by {@link #notifyAppLoaded()} for this
   *          browser window.
   */
