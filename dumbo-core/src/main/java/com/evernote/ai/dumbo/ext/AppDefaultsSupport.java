...
/**
 * Simplifies app development by automatically providing references to the app's default
...
public final class AppDefaultsSupport extends Extension {
  ...
  /**
   * Initializes this instance with default app JavaScript (/js/app.js) and CSS
   * (/css/default.css) resources.
   */
